  ...
  return (
    <footer className="bg-cream text-primary py-12 sm:py-16 md:py-20 relative overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        <div className="max-w-6xl mx-auto bg-white bg-opacity-90 rounded-xl shadow-xl p-6 sm:p-8 animate-scale-in">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-600">
                <li>
                  <a
                    href="#home"
                    className="hover:text-accent transition-all duration-300 transform hover:translate-x-2 font-glacial text-sm sm:text-base"
                  >
                    Home
                  </a>
                </li>
          ...
          <div className="border-t border-primary pt-6 sm:pt-8">
            ...
            <div className="mt-4 flex justify-center items-center space-x-2">
              ...
              />
              <p className="text-gray-600 text-sm sm:text-base font-glacial">
                Built by{' '}
                <a
